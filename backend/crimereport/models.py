...
class Crimereport(models.Model):
    ...
    '''intially was month in the 'uml' diagram and this is just autogenerated when the model is created, just a field that says when the report was created '''
    created = models.DateTimeField(editable=False)  
    '''intially was month in the 'uml' diagram and this is just autogenerated when the model is created and modified, just a field that says when the report was modified '''
    modified = models.DateTimeField(editable=False)
    # status should be hidden in the frontend since this is controlled by admin
    status = models.CharField(max_length=120, default="pending",blank=True)    
    categories = models.CharField(max_length = 100, choices = CATEGORY_CHOICES, default="Picking option")
    
    # the date of the crime, format: '%Y-%m-%d'
